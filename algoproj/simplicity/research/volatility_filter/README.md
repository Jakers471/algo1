...
**Run:**
- `python research/volatility_filter/vol_filter.py` — show enabled filters + % of NQ 5m bars tradeable (`mask(index)` / `passes(ts)`)
- `python research/volatility_filter/filter_variants.py` — compare variants (all/high/medium/low/…)
